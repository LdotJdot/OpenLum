---
name: leave-request
description: "在 xxxx 门户完成请假申请：登录 portal.xxxx.net.cn、跳转 xxxx 人力资源系统(xxxx.cn)、进入请假、填写表单、上传证明材料。Use when: 用户要求请假、提交请假申请、人力资源请假。"
---

# 请假申请 Skill

在 BEWG 门户登录后，跳转 iTalent 人力资源系统（https://www.xxxx.cn/）完成请假申请。需用户先登录门户或确认已登录，Agent 完成导航、表单填写、附件上传。
